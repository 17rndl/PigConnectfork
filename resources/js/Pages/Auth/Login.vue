      ...
      <form @submit.prevent="submit">
        <div class="mb-12">
          ...
          <p class="text-sm mt-4 text-gray-800">Don't have an account? 
            <a :href="route('register')" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a>
          </p>
        </div>
        ...
        <div>
          ...
          <div class="relative flex items-center">
            <TextInput name="email" type="text" v-model="form.email" required class="w-full text-gray-800 text-sm border-b border-[#C58A61] focus:border-[#C58A61] px-2 py-3 outline-none" placeholder="Enter email" />
        ...
        <div class="flex flex-wrap items-center justify-between gap-4 mt-6">
          <div class="flex items-center">
            <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 shrink-0 text-[#C58A61] focus:ring-[#C58A61] border-gray-300 rounded" />
